...
<head>
  ...
  <title><?php echo ucwords('BiblioTec Library Management System'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>BiblioTec</b></span>
    </a>
...
<br>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> <span>Escritorio</span></a></li>
        <li><a href="Users_view.php"><i class="fa fa-users"></i> <span>Socios</span></a></li>
        <li><a href="books_view.php"><i class="fa fa-book"></i> <span>Libros</span></a></li>
        <li><a href="Magazines_view.php"><i class="fa fa-file-word-o"></i> <span>Revistas</span></a></li>
        <li><a href="NewsPapers_view.php"><i class="fa fa-newspaper-o"></i> <span>Periodicos</span></a></li>
        <li><a href="Book_Issue_view.php"><i class="fa fa-space-shuttle"></i> <span>Emitidos</span></a></li>
        <li><a href="Return_Book_view.php"><i class="fa fa-thumbs-up"></i> <span>Devueltos</span></a></li>
         <li><a href="not_returned.php"><i class="fa fa-thumbs-down"></i> <span>No Devueltos</span></a></li>
        <li class="treeview">
          <a href="#"><i class="fa fa-cogs"></i> <span>Salir</span>
